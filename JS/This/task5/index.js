...
const func = sayName.apply(student);

const funcBruce = sayName.apply({ name: 'Bruce' });
...
const funcCompany = greeting.apply(company, ['Bob', 'Marley']);
...
const funcPopulation = getPopulation.apply(country, [43000]);
...
const funcTransaction = transaction.printTransaction.apply(anotherTransaction);
